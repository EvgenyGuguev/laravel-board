...
@section('content')
    ...
    <modal name="hello-world" classes="p-10 card rounded-lg" height="auto">
        ...
        <div class="flex">
            <div class="flex-1 mr-4">
                <div class="mb-4">
                    ...
                    <input type="text" id="title" class="rounded border p-2 text-xs w-full">
                </div>

                <div class="mb-4">
                    <label for="description" class="block mb-2">Description</label>
                    <textarea id="description" class="rounded border p-2 text-xs w-full" rows="7"> </textarea>
                </div>
            </div>
            ...
            <div class="flex-1 ml-4">
                <div class="mb-4">
                    ...
                    <input type="text" class="rounded border p-2 w-full" placeholder="task 1">
                </div>
        ...
        <footer class="flex justify-end">
            <button type="submit" class="mr-3 button-white">Cancel</button>
